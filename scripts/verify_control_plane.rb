...
fail!("release_stager_bound_artifact_hydration_missing") unless release_stager.include?("OMEGA_RELEASE_STAGE_BOUND_ARTIFACT_MISSING") && release_stager.include?("shutil.copy2")
