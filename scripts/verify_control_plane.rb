...
fail!("federation_second_proof_dispatch_missing") unless certifier.include?("gh workflow run omega-federation-v3-peer-bridge.yml --ref main") && certifier.include?("OMEGA_RELEASE_FEDERATION_SECOND_PROOF_DISPATCHED")
fail!("federation_recovery_dispatch_missing") unless certifier.include?("gh workflow run omega-hosted-recovery-failover.yml --ref main") && certifier.include?("OMEGA_RELEASE_FINAL_RECOVERY_DISPATCHED")
